...
public:
	...
	static bool IsInsideCylider(const FVector& start, const FVector& end, const FVector& point, float radius, bool onlyHalf = false);
	static bool IsInsideSphere(const FVector& center, const FVector& point, float radius);
	static bool IsInsideCapsule(const FVector& start, const FVector& end, const FVector& point, float radius);
	
	static bool IsInsideHalfCapsule(const FVector& start, const FVector& end, const FVector& point, float radius);
	static bool IsInsideHemisphere(const FVector& start, const FVector& end, const FVector& point, float radius);
};
